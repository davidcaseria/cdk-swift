 ...
 */
public protocol MeltQuoteProtocol : AnyObject {
...
open func state() -> QuoteState {
    return try!  FfiConverterTypeQuoteState.lift(try! rustCall() {
...
open func unit() -> CurrencyUnit {
    return try!  FfiConverterTypeCurrencyUnit.lift(try! rustCall() {
 ...
 */
public protocol MintQuoteProtocol : AnyObject {
...
open func mintUrl() -> MintUrl {
    return try!  FfiConverterTypeMintUrl.lift(try! rustCall() {
 ...
 */
public protocol PreparedSendProtocol : AnyObject {
 ...
 * FFI-compatible PreparedSend
 */
open class PreparedSend:
    PreparedSendProtocol {
    fileprivate let pointer: UnsafeMutableRawPointer!
...
open func confirm(memo: String?)async throws  -> Token {
    return
        try  await uniffiRustCallAsync(
            ...
            liftFunc: FfiConverterTypeToken.lift,
            errorHandler: FfiConverterTypeFfiError.lift
        )
}
...
public static func fromString(tokenStr: String)throws  -> Token {
    return try  FfiConverterTypeToken.lift(try rustCallWithError(FfiConverterTypeFfiError.lift) {
...
open func mintUrl()throws  -> MintUrl {
    return try  FfiConverterTypeMintUrl.lift(try rustCallWithError(FfiConverterTypeFfiError.lift) {
...
open func proofsSimple()throws  -> [Proof] {
    return try  FfiConverterSequenceTypeProof.lift(try rustCallWithError(FfiConverterTypeFfiError.lift) {
...
open func value()throws  -> Amount {
    return try  FfiConverterTypeAmount.lift(try rustCallWithError(FfiConverterTypeFfiError.lift) {
...
open class Wallet:
     ...
     * Create a new Wallet
     */
public convenience init(mintUrl: String, unit: CurrencyUnit, seed: Data, targetProofCount: UInt32?)async throws  {
    let pointer =
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_cdk_ffi_fn_constructor_wallet_new(FfiConverterString.lower(mintUrl),FfiConverterTypeCurrencyUnit.lower(unit),FfiConverterData.lower(seed),FfiConverterOptionUInt32.lower(targetProofCount)
                )
            },
            pollFunc: ffi_cdk_ffi_rust_future_poll_pointer,
            completeFunc: ffi_cdk_ffi_rust_future_complete_pointer,
...
open func melt(quoteId: String)async throws  -> Melted {
    return
        try  await uniffiRustCallAsync(
            ...
            completeFunc: ffi_cdk_ffi_rust_future_complete_rust_buffer,
            freeFunc: ffi_cdk_ffi_rust_future_free_rust_buffer,
            liftFunc: FfiConverterTypeMelted.lift,
            errorHandler: FfiConverterTypeFfiError.lift
        )
}
...
open func meltQuote(request: String, options: MeltOptions?)async throws  -> MeltQuote {
    return
        try  await uniffiRustCallAsync(
            ...
            completeFunc: ffi_cdk_ffi_rust_future_complete_pointer,
            freeFunc: ffi_cdk_ffi_rust_future_free_pointer,
            liftFunc: FfiConverterTypeMeltQuote.lift,
            errorHandler: FfiConverterTypeFfiError.lift
        )
}
        ...
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_cdk_ffi_fn_method_wallet_mint(
                    self.uniffiClonePointer(),
                    FfiConverterString.lower(quoteId),FfiConverterTypeSplitTarget.lower(amountSplitTarget),FfiConverterOptionTypeSpendingConditions.lower(spendingConditions)
                )
            },
            pollFunc: ffi_cdk_ffi_rust_future_poll_rust_buffer,
            completeFunc: ffi_cdk_ffi_rust_future_complete_rust_buffer,
        ...
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_cdk_ffi_fn_method_wallet_mint_quote(
                    self.uniffiClonePointer(),
                    FfiConverterTypeAmount.lower(amount),FfiConverterOptionString.lower(description)
                )
            },
            pollFunc: ffi_cdk_ffi_rust_future_poll_pointer,
            completeFunc: ffi_cdk_ffi_rust_future_complete_pointer,
            freeFunc: ffi_cdk_ffi_rust_future_free_pointer,
            liftFunc: FfiConverterTypeMintQuote.lift,
            errorHandler: FfiConverterTypeFfiError.lift
        )
}
        ...
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_cdk_ffi_fn_method_wallet_receive_proofs(
                    self.uniffiClonePointer(),
                    FfiConverterSequenceTypeProof.lower(proofs),FfiConverterTypeReceiveOptions.lower(options),FfiConverterOptionString.lower(memo)
                )
            },
            pollFunc: ffi_cdk_ffi_rust_future_poll_rust_buffer,
            completeFunc: ffi_cdk_ffi_rust_future_complete_rust_buffer,
        ...
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_cdk_ffi_fn_method_wallet_swap(
                    self.uniffiClonePointer(),
                    FfiConverterOptionTypeAmount.lower(amount),FfiConverterTypeSplitTarget.lower(amountSplitTarget),FfiConverterSequenceTypeProof.lower(inputProofs),FfiConverterOptionTypeSpendingConditions.lower(spendingConditions),FfiConverterBool.lower(includeFees)
                )
            },
            pollFunc: ffi_cdk_ffi_rust_future_poll_rust_buffer,
            completeFunc: ffi_cdk_ffi_rust_future_complete_rust_buffer,
 ...
 */
public protocol WalletBuilderProtocol : AnyObject {
    
    /**
     * Build the wallet
     */
    func build() async throws  -> Wallet
    
    /**
     * Set mint URL
     */
    func mintUrl(mintUrl: String) throws  -> WalletBuilder
    
    /**
     * Set seed
     */
    func seed(seed: Data)  -> WalletBuilder
    
    /**
     * Set target proof count
     */
    func targetProofCount(count: UInt32)  -> WalletBuilder
    
    /**
     * Set currency unit
     */
    func unit(unit: CurrencyUnit)  -> WalletBuilder
 ...
 * Create a wallet builder for more advanced configurations
 */
open class WalletBuilder:
    WalletBuilderProtocol {
    fileprivate let pointer: UnsafeMutableRawPointer!
...
#endif
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_cdk_ffi_fn_clone_walletbuilder(self.pointer, $0) }
    }
    /**
...
public convenience init()throws  {
    ...
    uniffi_cdk_ffi_fn_constructor_walletbuilder_new($0
    )
}
    self.init(unsafeFromRawPointer: pointer)
}
    ...
    deinit {
        ...
        try! rustCall { uniffi_cdk_ffi_fn_free_walletbuilder(pointer, $0) }
    }
     ...
     * Build the wallet
     */
open func build()async throws  -> Wallet {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_cdk_ffi_fn_method_walletbuilder_build(
                    self.uniffiClonePointer()
     ...
     * Set mint URL
     */
open func mintUrl(mintUrl: String)throws  -> WalletBuilder {
    return try  FfiConverterTypeWalletBuilder.lift(try rustCallWithError(FfiConverterTypeFfiError.lift) {
    uniffi_cdk_ffi_fn_method_walletbuilder_mint_url(self.uniffiClonePointer(),
        FfiConverterString.lower(mintUrl),$0
    )
})
}
     ...
     * Set seed
     */
open func seed(seed: Data) -> WalletBuilder {
    return try!  FfiConverterTypeWalletBuilder.lift(try! rustCall() {
    uniffi_cdk_ffi_fn_method_walletbuilder_seed(self.uniffiClonePointer(),
     ...
     * Set target proof count
     */
open func targetProofCount(count: UInt32) -> WalletBuilder {
    return try!  FfiConverterTypeWalletBuilder.lift(try! rustCall() {
    uniffi_cdk_ffi_fn_method_walletbuilder_target_proof_count(self.uniffiClonePointer(),
     ...
     * Set currency unit
     */
open func unit(unit: CurrencyUnit) -> WalletBuilder {
    return try!  FfiConverterTypeWalletBuilder.lift(try! rustCall() {
    uniffi_cdk_ffi_fn_method_walletbuilder_unit(self.uniffiClonePointer(),
        FfiConverterTypeCurrencyUnit.lower(unit),$0
    )
})
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeWalletBuilder: FfiConverter {

    typealias FfiType = UnsafeMutableRawPointer
    typealias SwiftType = WalletBuilder

    public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> WalletBuilder {
        return WalletBuilder(unsafeFromRawPointer: pointer)
    }

    public static func lower(_ value: WalletBuilder) -> UnsafeMutableRawPointer {
        return value.uniffiClonePointer()
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> WalletBuilder {
        let v: UInt64 = try readInt(&buf)
        // The Rust code won't compile if a pointer won't fit in a UInt64.
        // We have to go via `UInt` because that's the thing that's the size of a pointer.
        let ptr = UnsafeMutableRawPointer(bitPattern: UInt(truncatingIfNeeded: v))
    ...
    public static func write(_ value: WalletBuilder, into buf: inout [UInt8]) {
        // This fiddling is because `Int` is the thing that's the same size as a pointer.
        // The Rust code won't compile if a pointer won't fit in a `UInt64`.
        writeInt(&buf, UInt64(bitPattern: Int64(Int(bitPattern: lower(value)))))
    }
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeWalletBuilder_lift(_ pointer: UnsafeMutableRawPointer) throws -> WalletBuilder {
    return try FfiConverterTypeWalletBuilder.lift(pointer)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeWalletBuilder_lower(_ value: WalletBuilder) -> UnsafeMutableRawPointer {
    return FfiConverterTypeWalletBuilder.lower(value)
}
...
public struct FfiConverterTypeSendOptions: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SendOptions {
        return
            try SendOptions(
                ...
                conditions: FfiConverterOptionString.read(from: &buf), 
                amountSplitTarget: FfiConverterTypeSplitTarget.read(from: &buf), 
    ...
    public static func write(_ value: SendOptions, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionString.write(value.conditions, into: &buf)
        FfiConverterTypeSplitTarget.write(value.amountSplitTarget, into: &buf)
...
public struct WalletConfig {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(mintUrl: String?, unit: CurrencyUnit?, seed: Data?, targetProofCount: UInt32?) {
...
public struct FfiConverterTypeWalletConfig: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> WalletConfig {
        return
            try WalletConfig(
                ...
                seed: FfiConverterOptionData.read(from: &buf), 
    ...
    public static func write(_ value: WalletConfig, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionData.write(value.seed, into: &buf)
 ...
 * Utility functions
 */
public func generateSeed() -> Data {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_cdk_ffi_fn_func_generate_seed($0
    )
})
}
...
private var initializationResult: InitializationResult = {
    ...
    if (uniffi_cdk_ffi_checksum_func_generate_seed() != 40175) {
    ...
    if (uniffi_cdk_ffi_checksum_method_proof_witness() != 27545) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cdk_ffi_checksum_method_token_to_string() != 35365) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cdk_ffi_checksum_method_walletbuilder_build() != 6758) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cdk_ffi_checksum_method_walletbuilder_mint_url() != 58383) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cdk_ffi_checksum_method_walletbuilder_seed() != 58859) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cdk_ffi_checksum_method_walletbuilder_target_proof_count() != 3448) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cdk_ffi_checksum_method_walletbuilder_unit() != 57993) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cdk_ffi_checksum_constructor_token_from_string() != 50768) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cdk_ffi_checksum_constructor_wallet_new() != 38078) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cdk_ffi_checksum_constructor_walletbuilder_new() != 1899) {
        return InitializationResult.apiChecksumMismatch
    }
